...
namespace Torian.Common.Imaging
{
    ...
    public class Watermarker
    {
        ...
        private Color m_fontOutlineColor = Color.White;
        ...
        /// Color of the text to add
        /// </summary>
        public Color FontOutlineColor { get { return m_fontOutlineColor; } set { m_fontOutlineColor = value; } }

        /// <summary>
        /// the width of the outline
        /// </summary>
        public float OutlineWidth { get { return m_outlineWidth; } set { m_outlineWidth = value; } }
        ...
        private Image GetTextWatermark(string text)
        {
            ...
            using (Graphics g = Graphics.FromImage(bitmap))
            {
                if (m_outlineWidth > 0)
                {
                    ...
                    {
                        gp.AddString(text, m_font.FontFamily, (int)FontStyle.Regular, m_font.Size, new Point(0, 0), new StringFormat());

                        //draw the outline
                        using (var pen = new Pen(m_fontOutlineColor, m_outlineWidth))
                        {
